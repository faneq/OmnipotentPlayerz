...
public class RecyclerViewSpace extends RecyclerView.ItemDecoration {
    private int space;
    private int color = -1;
    ...
    public RecyclerViewSpace(int space) {
        this.space = space;
    }

    public RecyclerViewSpace(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public RecyclerViewSpace(int space, int color,int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public RecyclerViewSpace(int space, Drawable mDivider) {
        this.space = space;
